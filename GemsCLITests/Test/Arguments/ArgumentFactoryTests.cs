...
namespace GemsCLITests.Test.Arguments
{
    ...
    public class ArgumentFactoryTests
    {
        ...
        public void Create_1()
        {
            ...
            Assert.AreEqual("on", arg.ValueType);
